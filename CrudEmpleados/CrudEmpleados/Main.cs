...
namespace CrudEmpleados
{
    ...
    {   
        ...
        {
            List<Empleados> empleados = _capaDeNegocios.TraerContactos();
            gridContacts.DataSource = empleados;
        }
        private void dataGridView1_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (cell.Value.ToString() == "Editar")
            {
                ...
                contactDetails.CargarContacto(new Empleados
                {
                    idempleado = int.Parse(gridContacts.Rows[e.RowIndex].Cells[0].Value.ToString()),
                    ...
                    Email = gridContacts.Rows[e.RowIndex].Cells[5].Value.ToString(),
                });
        ...
        {
            List<Empleados> empleados = _capaDeNegocios.TraerContactos(textoBusqueda);
            gridContacts.DataSource = empleados;
        }
    }
